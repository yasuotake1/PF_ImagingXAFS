...
public class Menu_XANES extends JFrame implements WindowListener, PlugIn {
	...
	public void run(String arg) {
		...
		impsRaw = xanesmap.method1(prop.listSuffixes, BL15A1Common.listChName, prop);
		if (checkNull(impsRaw))
			return;
		impsI0Corr = xanesmap.method2(impsRaw, BL15A1Common.listI0CorrName, prop);
		IJ.run("Tile");
		...
		MenuFrame.setBounds(150, 150, 280, 135);
